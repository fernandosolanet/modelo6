...
GASTOS = array([20, 20, 20])  # Gasto másico (kg/s)
ISPS = array([280, 280, 280])  # Impulso específico (s)
MASA_DE_PAGO = 40  # Masa de la carga de pago (kg)
MASAS = array([635, 215, 110, MASA_DE_PAGO])
MASA_TOTAL = float(sum(MASAS))
ESTRUCTURAS = array([0.2, 0.2, 0.2])  # Razón estructural
RETARDOS = array([10, 5, 5])
