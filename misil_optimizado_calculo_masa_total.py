...
#from mach_inicial import vector

#velo1 = vector

def misil(vel, alt, filist, psilist, machlist):
...
#        gastotexto = str(mach_envolvente[i])
        ...
        for i in range(140, len(z5), 1):
            
            altitud = str(alt[0])
            
            velocidad = str(machlist[0])
            nombre = str(velocidad + altitud)
            ...
            while error > 10 and contador <= 50:
                ...
                z0 = alt[i]  # Altura a la que se lanza.
                v0 = vel[i]  # Velocidad inicial con la que se lanza.
        ...
        return (z0, zl, theta_grados0, theta_grados, vl, masa_total, i)



#    and z0 and theta_grados0 and zl and vl and masa_total and theta_grados and i
