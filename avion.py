...
for i in range(a, b):
    ...
    #    print('La envolvente de vuelo se extiende desde el Mach: 0.6 hasta', format(dom_3, '.3f'))
    
    #M = float(input('Introduce un número de Mach que pertenezca a la envolvente: '))
