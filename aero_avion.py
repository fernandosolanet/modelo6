...
def cl (mach, angulo_ataque_radians) :
    ...
    #Se importan los archivos con los CL      
        ...
        Mach1 = open(os.path.join('Interpolacion_cl', '0.80'), 'r')
        AoA1 = []
        CL1 = []
        for line in Mach1:
            s = line.strip()
        ...
        Mach2 = open(os.path.join('Interpolacion_cl', '0.85'), 'r')
        AoA2 = []
        CL2 = []
        for line in Mach2:
            s = line.strip()
...
#Generación de 'archivo', donde se almacenaran los datos.
    ...
    #Se importan los archivos con los CL  
        ...
        Mach1 = open(os.path.join('Interpolacion_cl', '0.85'), 'r')
        AoA1 = []
        CL1 = []
        for line in Mach1:
            s = line.strip()
        ...
        Mach2 = open(os.path.join('Interpolacion_cl', '1.00'), 'r')
        AoA2 = []
        CL2 = []
        for line in Mach2:
            s = line.strip()
    ...
    #Se importan los archivos con los CL  
        ...
        Mach1 = open(os.path.join('/Interpolacion_cl/', '/1.00'), 'r')
        AoA1 = []
        CL1 = []
        for line in Mach1:
            s = line.strip()
        ...
        Mach2 = open(os.path.join('Interpolacion_cl', '1.15'), 'r')
        AoA2 = []
        CL2 = []
        for line in Mach2:
            s = line.strip()
...
#         Se importan los archivos con los CL  
        ...
        Mach1 = open(os.path.join('Interpolacion_cl', '1.55'), 'r')
        AoA1 = []
        CL1 = []
        for line in Mach1:
            s = line.strip()
        ...
        Mach2 = open(os.path.join('Interpolacion_cl/', '1.95'), 'r')
        AoA2 = []
        CL2 = []
        for line in Mach2:
            s = line.strip()
...
def angulo_ataque(mach, cl):    
    ...
    if mach < 0.0:
        ...
        A1 = open(os.path.join('Interpolacion_cl', '0_8'), 'r')
        CL1 = []
        AoA11 = []
        for line in A1:
            s = line.strip()
        ...
        A2 = open(os.path.join('Interpolacion_cl', '0_85'), 'r')
        CL2 = []
        AoA12 = []
        for line in A2:
            s = line.strip()
...
#        
        ...
        A1 = open(os.path.join('Interpolacion_cl', '0_85'), 'r')
        CL1 = []
        AoA11 = []
        for line in A1:
            s = line.strip()
        ...
        A2 = open(os.path.join('Interpolacion_cl/', '1_0'), 'r')
        CL2 = []
        AoA12 = []
        for line in A2:
            s = line.strip()
...
#        
        ...
        A1 = open(os.path.join('Interpolacion_cl', '1_0'), 'r')
        CL1 = []
        AoA11 = []
        for line in A1:
            s = line.strip()
        ...
        A2 = open(os.path.join('Interpolacion_cl', '1_15'), 'r')
        CL2 = []
        AoA12 = []
        for line in A2:
            s = line.strip()
...
#        
        ...
        A1 = open(os.path.join('Interpolacion_cl', '1_55'), 'r')
        CL1 = []
        AoA11 = []
        for line in A1:
            s = line.strip()
        ...
        A2 = open(os.path.join('Interpolacion_cl', '1_95'), 'r')
        CL2 = []
        AoA12 = []
        for line in A2:
            s = line.strip()
...
def cd0(mach):
    if 0.4 <= mach < 0.85:
        return 1.95848836*mach**5 - 5.80486501*mach**4 + 6.79134382*mach**3 - 3.91889256*mach**2 + 1.11508822*mach - 0.107052712
    if 0.85 <= mach < 2.2:
        return -0.0356441582*mach**6 + 0.492704252*mach**5 - 2.59772446*mach**4 + 6.88074310*mach**3 - 9.79540689*mach**2 + 7.15966088*mach - 2.06433571
