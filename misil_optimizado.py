...
from modulos.inputs_iniciales import AZ, LAT
from modulos.atmosfera.modelo_msise00 import density, temperature, GAMMA, viscosity, R_AIR
from modulos.atmosfera.gravedad import gravity
from modulos.aerodinamica.aero_misil import cdll, SREF_MISIL, SGASES

from modulos.velocidad_rotacional_antiguo import vel_rotacional




def misil_carga_pago(vel, alt, filist, psilist, machlist, inicio):
    ...
    for gasto in [14]:
        ...
        for j in range(a, len(z5), 1):
            ...
            while error > 10 and contador <= 50:
                ...
                z0 = alt[j]  # Altura a la que se lanza.
                v0 = vel[j]  # Velocidad inicial con la que se lanza.
                fil_grados0 = FI_GRADOS[j]
                # Ángulo de ataque de la VELOCIDAD sobre la vertical local.
                psil_grados0 = PSI_GRADOS[j]
                ...
                E_mecanica_misil_lanzamiento = 1000 * (gravity(zl) * zl + (vl ** 2) / 2)
            ...
            theta_grados = 90 - fil_grados
    
            if zl > 500000:
                break
            
        return (z0,v0, zl, theta_grados0, theta_grados, vl,E_mecanica_misil_lanzamiento, masa_util, j)
